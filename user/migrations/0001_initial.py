# Generated by Django 3.2.4 on 2022-02-28 13:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip', models.CharField(default='0.0.0.0', max_length=32, verbose_name='访问ip')),
            ],
            options={
                'verbose_name': '访问信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='留言人名字')),
            ],
            options={
                'verbose_name': '留言',
